...
class AccountsTestCase(TestCase):
    ...
    def test_get_user_list(self):
        object_list1 = MboClient.objects.get_users_info_list('2015-08-01', '2015-08-31')
        object_list2 = MboClient.objects.get_users_info_list('2016-07-01', '2016-08-31')
        self.assertEquals(0, object_list1.count())
        self.assertEquals(4, object_list2.count())
