...
class SaleServiceCalls():
    ...
    def GetServices(self, site_ids,
                          ...
                          staffId=None):
        result = SaleServiceMethods().GetServices(site_ids,
                                                  locationId,
                                                  programIds,
                                                  sessionTypeIds,
                                                  serviceIds, 
...
class SaleServiceMethods():
    ...
    def CheckoutShoppingCart(self, cartId,
                                   ...
                                   mbo_username,
                                   mbo_password):
        request = self.CreateBasicRequest("CheckoutShoppingCart", mbo_site_ids=mbo_site_ids, mbo_username=mbo_username,
                                          mbo_password=mbo_password)
        ...
        request.Fields = BasicRequestHelper.FillArrayType(self.service, fieldname, "String")
    ...
    def CreateCartItem(self, arrayToFill,
        ...
        cartItem.ClassIDs = BasicRequestHelper.FillArrayType(self.service, classIds, "Int")
    ...
    def GetServices(self, site_ids,
                          ...
                          hideRelatedPrograms, 
                          staffId):
        request = self.CreateBasicRequest("GetServices", mbo_site_ids=site_ids)
